...
<script type="text/javascript">
	...
	$url = "http://app.getdasher.com/filmstrip2/styles.php"+$vars;
						...
						.done(function( script, textStatus ) {
							jQuery('#items').bxSlider({
								...
								onSliderLoad: function(){
									...
									jQuery('[type=dasher-small]').fancybox({
												type : 'image',
												afterLoad: function() {
						...
						if( count($photos) > 0 ):
						 foreach( $photos as $photo): 
							 if($photo['approval_status'] != ""): 
				                 ...
				                 <div class="slide"><a href="<?php echo $photo['url']; ?>" class="fancybox" type="dasher-small" fancy-title='<?php getTypeImage($photo['type']); ?> <a href="<?php echo $photo['userlink']; ?>" target="_blank"><?php echo $photo['username']; ?></a> <?php echo $photo['captions']; ?> <a href="<?php echo $photo['postlink']; ?>" target="_blank">View the Post</a>'><img src="<?php echo $photo['url']; ?>" />
