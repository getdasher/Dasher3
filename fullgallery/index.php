...
$width = jQuery( '.dasher2' ).width();
	...
	jQuery(document).ready(function(){
		...
		jQuery.getScript( "https://app.getdasher.com/js/photomosaic.min.js")
			.done(function( script, textStatus ) {
...
<?php
	...
	function getTypeImage($picID){
		switch ($picID) {
		    case 1:
		        echo '<img src="https://app.getdasher.com/images/twitter-24.png" alt="twitter" class="icon" /> ';
		        break;
		    case 2:
		        echo '<img src="https://app.getdasher.com/images/instagram-24.png" alt="instagram" class="icon" /> ';
		        break;
		    case 3:
		        echo '<img src="https://app.getdasher.com/images/googleplus-24.png" alt="googleplus" class="icon" /> ';
		        break;
			case 4:
			    echo '<img src="https://app.getdasher.com/images/facebook-24.png" alt="facebook" class="icon" /> ';
			    break;
		}
	}
...
<?php	
	...
	echo '<div style="clear:both;"></div><div id="container"><ul>';
			...
			echo '<div style="clear:both;"></div><a href="http://getdasher.com" target="_blank"><img class="dasher-branding" src="https://app.getdasher.com/images/icons/powered_by_dasher_dark.png" /></a>';
			}
			else{
					echo '<div style="clear:both;"></div><a href="http://getdasher.com" target="_blank"><img class="dasher-branding" src="https://app.getdasher.com/images/icons/powered_by_dasher_light.png" /></a>';
			}
