...
<div class="newsignup-form">
	...
	<form method="POST" class="signup-form" id="form1" action="/user_create.php">
		...
		<input  type="checkbox" name="tou" value="yes" style="display:inline-block; width:10%;"  required ><span style="font-size:12px; width:88%; padding-top:0px; text-align:left; display:inline-block;">I agree to the <a href="/terms-of-use/" target="_blank">Dasher Terms and Conditions</a></span>
		<div class="error"></div>
