...
<?php } 
elseif(!isset($_COOKIE['stripe'])) { ?>
	<div class="billing-info">
			<h1><i class="fa fa-credit-card"></i> Payment Information</h1>
			<p>Select a plan that meets your needs and enter your billing information.</p>
			<a href="http://app.getdasher.com/create_account.php" class="action_button">Select Plan</a>
		</div>	
<?php }
else { ?>
	<div class="billing-info">
		<h1><i class="fa fa-credit-card"></i> Renew Account</h1>
		<p>Click below to refresh your billing information by editing / adding a credit card.</p>
