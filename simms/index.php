...
if($width < 960){
	jQuery('head').append("<link rel='stylesheet' id='dasher-style-css'  href='http://app.getdasher.com/simms/galleryMobile.css' type='text/css' media='all' />");
...
jQuery('head').append("<link rel='stylesheet' id='dasher-style-css'  href='http://app.getdasher.com/simms/gallery.css' type='text/css' media='all' />");
	  jQuery(document).ready(function(){
...
<header id="masthead" class="site-header" role="banner">
    <div class="header-body">
		<div class="site-branding ">
			<div class="gallery-banner"><a href="http://simmsfishing.com" target="_blank" ><img src="http://app.getdasher.com/simms/Dasher-Art-Simms_03.png"></a><div class="hash-title">#simmsbass</div>
			<div class="network-icons"><span class="icon"><span class="socicon">a</span></span><span class="icon"><span class="socicon">x</span></span><span class="icon"><span class="socicon">b</span></span></div></div>
			<a href="http://getdasher.com" target="_blank" style="float:right;"><img src="http://app.getdasher.com/images/hatch_header_08.png"></a>
		</div>
			      </div>
	</header>
...
<?php	
	echo '<div id="container"><div class="brick w'.$count3.'">';
							 ...
							 if($photo['approval_status'] != ""): 
								...
								<?php //$size = getimagesize($photo['url']); ?>
								 <div id="container-card">
									 <div class="card" rel="gallery1" href="<?php echo $photo['url']; ?>" titler='<span class="tooltip"><?php getTypeImage($photo['type']); ?><br /><a href="<?php echo $photo['userlink']; ?>" target="_blank"><?php echo $photo['username']; ?></a> <?php echo $photo['captions']; ?><br /><a href="<?php echo $photo['postlink']; ?>" target="_blank">View the Post &#8611;</a></span>'  >
			...
			<div style="clear:both;"></div><a href="http://getdasher.com" target="_blank" style="position: absolute; bottom: 0; width: 688px; left: 15%;"><img class="dasher-branding" src="http://app.getdasher.com/images/powered_by_dasher1.png" width="688" /></a>';
			else: 
