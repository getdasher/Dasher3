...
function arraySearch(arr,val) {
	...
	$(document).ready(function(){
		...
		$('.widget-preview').click(function(){
			$('.fullgallery-preview, .masonry-preview').css('border', '2px solid #fff');
			$(this).css('border', 'solid 2px #f4922e');
			$type = "filmstrip";
		});
		$('.fullgallery-preview').click(function(){
			$('.widget-preview, .masonry-preview').css('border', '2px solid #fff');
			$(this).css('border', 'solid 2px #f4922e');
			$type = "fullgallery";
		});
		$('.masonry-preview').click(function(){
			$('.widget-preview, .fullgallery-preview').css('border', '2px solid #fff');
			$(this).css('border', 'solid 2px #f4922e');
			$type = "masonry";
		});
