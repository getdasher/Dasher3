...
<div class="campaign-alert"<?php if($_GET['alert'] == 'newcampaign'){ echo " style='display:block;'"; } ?> ><?php if($_GET['alert'] == 'newcampaign'){ echo "Dasher takes just a few minutes to gather your first photos. So hang tight."; } ?></div>
<?php }
...
$campaigns = $dbCamps->query('SELECT * FROM `campaign` WHERE `deleted` != 1');
}
