...
jQuery(document).ready(function(){
    ...
    jQuery('head').append($append1);
		jQuery.getScript( "http://app.getdasher.com/fullgallery/imagesloaded.pkgd.min.js").done(function(){
...
<?php	
	...
	echo '<div class = "waiting" style="margin:auto; width:200px; text-align:center; font-family: Arial; color:#F0F0F0; margin-top:100px;"><img src="http://app.getdasher.com/images/ajax-loader.gif" /><br /><br /><img src="http://app.getdasher.com/images/logo-header.png" /></div><div style="clear:both;"></div><div id="container" style="margin-top:0;">';
						if( count($photos) > 0 ):
