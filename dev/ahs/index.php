...
<header id="masthead" class="site-header" role="banner" style="height:100px;">
    <div class="header-body">
		<div class="site-branding">
			<p class="hashtag-icon" style="margin-left: 35%; color: #f37520; font-size: 50px; font-family: 'Open Sans', sans-serif; margin-bottom:0; font-style:italic;">#AHScareers</p>
			<a href="http://getdasher.com" target="_blank"><img src="http://app.getdasher.com/images/hatch_header_08.png" class="gallery_logo" style="padding-top: 0; margin-top: -50px;"></a>
		</div>
			      </div>
	</header>
...
?>
<?php	
	echo '<div id="container"><div class="brick w5">';
						if( count($photos) > 0 ):
						 foreach( $photos as $photo): 
							 if($photo['approval_status'] != ""): 
								...
								if($count3 == 11){
									echo '</div><div class="clearfix"></div><div class="brick w5">';
									$count3 = 1;
								}
						 endif;
				              endif;
