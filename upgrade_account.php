...
switch ($userType) {
    case 1:
		...
		$proYear = "Select Plan";
		$starterButton = "Select Plan";
		$starterYear = "Select Plan";
        break;
    case 2:
...
<ul class="pricing_table year-table">
    ...
    <li class="price_block">
        ...
        <div class="footer">
            <a href="/contact.php"><button class="support-link">Contact</button></a>
        </div>
    </li>
     <div style="clear:both;"></div>
    <hr />
    <div class="starter" style="text-align:center;">
   	 <strong style="margin-right:20px;">Starter Plan</strong> One Hashtag, One Gallery $8.99/year
<div class="button changePlan <?php echo $starterYear; ?>" type="8" tags="1"><?php echo $starterYear; ?></div>
    </div>
    <hr />
</ul>
<ul class="pricing_table month-table">
    ...
    <hr />
    <div class="starter" style="text-align:center;">
   	 <strong style="margin-right:20px;">Starter Plan</strong> One Hashtag, One Gallery $9.99/mo
<div class="button changePlan <?php echo $starterButton; ?>" type="7" tags="1"><?php echo $starterButton; ?></div>
   	</form>
    </div>
    <hr />
</ul>
