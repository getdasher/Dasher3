...
$count2 = 1; ?>
<link rel='stylesheet' id='dasher-style-css'  href='http://getdasher.com/dasher-tools/user-iframe3.css' type='text/css' media='all' />
<link rel='stylesheet' id='dasher-style-css'  href='http://getdasher.com/fancybox/jquery.fancybox.css' type='text/css' media='all' />
...
<script type="text/javascript" language="javascript" src="http://getdasher.com/dasher-tools/fancybox/jquery.fancybox.js"></script>
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		jQuery('#items').carouFredSel({
			circular: true, 
			auto: false,
			scroll : {  items: 2, easing : "quadratic",  duration : 700 },
			prev: '#prev',
			next: '#next',
			mousewheel: true,
			swipe: {
						...
						if( count($photos) > 0 ):
						 foreach( $photos as $photo): 
							 if($photo['approval_status'] != ""): 
				                 ...
				                 <li style="background-image:url(<?php echo $photo['url']; ?>);" href="<?php echo $photo['url']; ?>" rel="prettyPhoto" titler='<?php getTypeImage($photo['type']); ?> <a href="<?php echo $photo['userlink']; ?>" target="_blank"><?php echo $photo['username']; ?></a> <?php echo $photo['captions']; ?> <a href="<?php echo $photo['postlink']; ?>" target="_blank">View the Post</a>' class="dasher-gallery"></li><?php
						 endif;
				              endif;
						 endforeach;
				echo '</ul>
