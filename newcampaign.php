...
if(isset($_GET['q'])){	?>
	...
	<form action="" method="post" style="margin-top:50px; width:100%; font-size:12px;">
		...
		<input type = "submit" value="create tag" class='create-tag' />
	</form>
</div>
<script>
		jQuery('.create-tag').click(function(){
			jQuery('.new-tag').html('<div class="modal-header">CREATING HASHTAG</div><div class = "waiting" style="margin:auto; width:200px; text-align:center; font-family: Arial; color:#f4922e; margin-top:100px;"><img src="http://app.getdasher.com/images/712.gif" /><br />Setting Up Your Campaign.</div>');
		});
</script>
<?php } else { 
